...
long with numerous small changes to the internal code for efficiency
...
{\tt vglm} function in package {\tt VGAM}.
...
done by refitting both models using a combined data frame created via {\tt merge}.  
...
and users may also pass options for {\tt vcovHC} to compute different types of
...
The function is intended for exploratory analyses and users are cautioned against
...
\hline
\end{tabular}
\caption{The Types of Data That Can be Handled by {\tt mediate} for the
...
\hline
\end{tabular}
\caption{The Types of Data That Can Be Handled by {\tt medsens} for
