...
{\title{\bf \tit\thanks{The most recent version (along with all
      previous versions) of the {\bf R} package, {\bf mediation}, is
      available for download at the Comprehensive R Archive Network
      (\href{http://cran.r-project.org/web/packages/mediation}{http://cran.r-project.org/web/packages/mediation}.
      This paper is based on version 2.0 of {\bf mediation}.
  ...
  \author{Kosuke Imai\thanks{Assistant Professor, Department of
    ...
    \quad \quad Luke Keele\thanks{Assistant Professor, Department of
      Political Science, 2140 Derby Hall, Ohio State University,
      Columbus, OH 43210 Phone: 614-247-4256, Email:
      keele.4@polisci.osu.edu} \quad \quad Dustin
    Tingley\thanks{Ph.D. candidate, Department of Politics, Princeton
      University, Princeton NJ 08544, Email: dtingley@princeton.edu}
...
\begin{abstract}
  ...
  \citet*{imai:keel:yama:08} and \citet*{imai:keel:ting:09} developed
...
Recently, \citet*{imai:keel:yama:08} and \citet*{imai:keel:ting:09}
...
\citet{imai:keel:yama:08,imai:keel:ting:09} also develop sensitivity
...
examples presented in \citet{imai:keel:ting:09}.
...
\citet{imai:keel:yama:08,imai:keel:ting:09} for more information about
...
assumption of \citet{imai:keel:yama:08}, {\small \begin{eqnarray}
...
using the algorithms proposed in \citet{imai:keel:ting:09}.  The
...
Algorithms~1~and~2 of \citet{imai:keel:ting:09}. These are general
...
\citet{imai:keel:ting:09} for standard parametric models.  First,
...
\citet{imai:keel:yama:08,imai:keel:ting:09} develop sensitivity
analyses for commonly used parametric models, which we implement in
\bmediation.

\paragraph{The Baron-Kenny Procedure.}

\citet{imai:keel:yama:08} develop a sensitivity analysis for the
Baron-Kenny procedure and \citet{imai:keel:ting:09} generalize it to
...
mediator is not.  Theorem~2 of \citet{imai:keel:ting:09} shows how the
...
\citet{imai:keel:ting:09} derive the average causal mediation effects
...
sensitivity parameter.  \citet{imai:keel:ting:09} show that under this
...
this limitation, \citet{imai:keel:yama:08} proposed alternative
interpretations of $\rho$ based on the coefficients of determination
or $R^2$ and \citet{imai:keel:ting:09} extended them to the binary
...
\citet{imai:keel:ting:09}.  For example, one outcome of interest in
...
obtained as in the fully continuous case \citep[see][Section 4]{imai:keel:yama:08}.
...
methods and algorithms introduced by \citet*{imai:keel:yama:08} and
\citet*{imai:keel:ting:09}.  The software provides a flexible, unified
...
\bibliography{my,imai,keele_revised2,TingleyBib}
