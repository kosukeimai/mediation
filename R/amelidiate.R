...
#' 
#' \code{amelidiate} is designed to help users process multiple datasets where
#' missing values have been imputed. First create multiple datasets using your
#' preferred imputation software. Next pass the data sets, as shown in the
#' example below, to the \code{\link{mediations}} function. Finally pass the
#' output of mediations through the \code{amelidiate} function. This will
#' output an object that can then be passed through the standard summary and
#' plot commands.
#' 
