        ...
        if(INT==TRUE){if("indirect" %in% effect.type){
            ...
            if("direct" %in% effect.type){
            	z0.var[i,] <- v.y[T.cat, T.cat] + 
            		(m.coefs[paste("(Intercept)"), ] + 0*m.coefs[paste(T.cat), ] + sum(m.coefs[-(match(c("(Intercept)", paste(T.cat)), names(model.m$coefficients))),]*m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]))^2*v.y[int.lab, int.lab] + 
            		y.coefs[paste(int.lab),]^2*(v.m[paste("(Intercept)"),paste("(Intercept)")] + 0*v.m[T.cat,T.cat] + sum((m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))])*(v.m[-(match(c("(Intercept)", T.cat), names(model.m$coefficients))),-(match(c("(Intercept)", T.cat), names(model.m$coefficients)))])*(m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))])) + 2*0*v.m["(Intercept)",T.cat] + 2*0*sum(m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]*v.m[T.cat,][-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]) + 2*0*sum(m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]*v.m["(Intercept)",][-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))])) + 
            		v.y[int.lab, int.lab]*(v.m[paste("(Intercept)"),paste("(Intercept)")] + 0*v.m[T.cat,T.cat] + sum((m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))])*(v.m[-(match(c("(Intercept)", T.cat), names(model.m$coefficients))),-(match(c("(Intercept)", T.cat), names(model.m$coefficients)))])*(m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))])) + 2*0*v.m["(Intercept)",T.cat] + 2*0*sum(m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]*v.m[T.cat,][-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]) + 2*0*sum(m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]*v.m["(Intercept)",][-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))])) + 
            		(m.coefs[paste("(Intercept)"), ] + 0*m.coefs[paste(T.cat), ] + sum(m.coefs[-(match(c("(Intercept)", paste(T.cat)), names(model.m$coefficients))),]*m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]))*v.y[T.cat,int.lab]
            	
            	z1.var[i,] <- v.y[T.cat, T.cat] + 
            		(m.coefs[paste("(Intercept)"), ] + m.coefs[paste(T.cat), ] + sum(m.coefs[-(match(c("(Intercept)", paste(T.cat)), names(model.m$coefficients))),]*m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]))^2*v.y[int.lab, int.lab] + 
            		y.coefs[paste(int.lab),]^2*(v.m[paste("(Intercept)"),paste("(Intercept)")] + v.m[T.cat,T.cat] + sum((m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))])*(v.m[-(match(c("(Intercept)", T.cat), names(model.m$coefficients))),-(match(c("(Intercept)", T.cat), names(model.m$coefficients)))])*(m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))])) + 2*v.m["(Intercept)",T.cat] + 2*sum(m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]*v.m[T.cat,][-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]) + 2*sum(m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]*v.m["(Intercept)",][-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))])) + 
            		v.y[int.lab, int.lab]*(v.m[paste("(Intercept)"),paste("(Intercept)")] + v.m[T.cat,T.cat] + sum((m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))])*(v.m[-(match(c("(Intercept)", T.cat), names(model.m$coefficients))),-(match(c("(Intercept)", T.cat), names(model.m$coefficients)))])*(m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))])) + 2*v.m["(Intercept)",T.cat] + 2*sum(m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]*v.m[T.cat,][-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]) + 2*sum(m.bar[-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))]*v.m["(Intercept)",][-(match(c("(Intercept)", paste(T.cat)), names(m.bar)))])) + 
