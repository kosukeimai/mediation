# R package mediation: causal mediation analysis [![Build Status](https://travis-ci.org/weihuangwong/mediation.svg?branch=master)](https://travis-ci.org/weihuangwong/mediation)
